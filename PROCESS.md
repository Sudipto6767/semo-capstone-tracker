...
Scrum was selected because it allows the project to be divided into smaller user stories and developed through short sprints. Although the overall requirements of the application are known, some details may change during development and testing. Scrum allows new requirements or changes to be added to the backlog and prioritized for future work.
...
At the end of each sprint, I will review the completed work and determine whether any requirements or priorities need to be changed for the next sprint.
